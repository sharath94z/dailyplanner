...
describe("normalizeSupabaseDatabaseUrl", () => {
  ...
  it("overrides an existing connect_timeout for Supabase pooler URLs", () => {
    const url = normalizeSupabaseDatabaseUrl(
      "postgresql://postgres.prlbigurpbryeubkyswv:secret@aws-1-ap-northeast-1.pooler.supabase.com:5432/postgres?connect_timeout=5"
    );
